...
"""
Пример испоользования библиотеки BeautifulSoup. На вход подаются 2 ссылки,
задача программы вывести 'Yes' если из 1ой ссылки во 2ю можно перейти в 2 клика,
...
def check(url_1, url_refer):
    go_url_1 = req.get(url_1)  # присваивание содержимого страницы переменной
    print('resp = ', go_url_1)  # .text - отобразить все в тексте
